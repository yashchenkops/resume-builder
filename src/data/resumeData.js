...
export const education = [
  {
    ...
    description: [
      'Engaged in comprehensive coursework on Agile methodologies, risk management, and stakeholder analysis.',
      'Led a capstone project simulating a cross-functional product launch.',
    ],
  },
  {
    id: 'careeros-ba',
    ...
    description: [
      'Completed coursework in corporate finance, marketing strategy, and organizational behavior.',
      'Collaborated on a consulting project for a local startup to optimize operations.',
    ],
  },
];
